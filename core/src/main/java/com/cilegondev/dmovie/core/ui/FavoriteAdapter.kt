...
import kotlinx.android.synthetic.main.item_movie_row.view.imgPoster
import kotlinx.android.synthetic.main.item_movie_row.view.rating
import kotlinx.android.synthetic.main.item_movie_row.view.tvGenres
import kotlinx.android.synthetic.main.item_movie_row.view.tvTitle
        ...
        fun bind(movie: Movie) {
            ...
            with(itemView) {
                ...
                Glide.with(itemView.context)
                    ...
                    .into(imgPoster)
                if (movie.type == MovieEntity.TYPE_MOVIE){
                    tvType.text = context.getText(R.string.movie)
                    Glide.with(itemView.context)
                    ...
                    tvType.text = context.getText(R.string.tv_show)
                    Glide.with(itemView.context)
                        .load(R.drawable.ic_live_tv)
                        .apply(
                            RequestOptions.placeholderOf(R.drawable.ic_loading).error(R.drawable.ic_error)
                        )
                        .into(imgType)
